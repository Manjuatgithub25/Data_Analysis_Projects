...
3) In the part of data cleaning and transformation, messy date formats are handled in voth shipping & order dates and Churn feature is engineered to determine how much
   profit margin does exiting customer carried with them over the years.
4) Dax functions are used to determine profit margins to understand product level profits to achieve our main goal and as mentioned in second point to analyse how
